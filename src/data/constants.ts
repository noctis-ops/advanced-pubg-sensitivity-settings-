...
export const BASE_SENSITIVITY: {
  ...
  // Gyro is deliberately below the 400 slider ceiling. Recoil and scope
  // demand are applied later; starting at the ceiling would erase weapon and
  // magnification differences through clamping.
  gyroscope: {
    noScope: 245,
    redDot: 215,
    x2: 195,
